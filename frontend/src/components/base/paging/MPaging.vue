<template>
    <div class="paging__group-button">
        ...
        <div class="button__number-group">
            ...
            <button class="paging__number" v-for="(page,index) in pages" :key="index" @click="clickSelectedPage(index)" :class="{'button__number-selected': activeIndex === index}">{{page.textNumber}}</button>
        </div>
...
export default {
    ...
    data() {
        return {
            // Tổng số trang
            totalPage: this.totalRecord / this.currentPage,
